        ...
        return (
            <header className="header">
                <nav className={classNames('nav', {'nav--light': white_header, 'nav--dark': white_header !== true})}>
                    <div className="nav__logo" {...((white_header || (_.get(page, 'frontmatter.template', null) === 'product')) ? ({"data-original": withPrefix(_.get(site, 'siteMetadata.logo_light', null))}) : null)} data-dark={withPrefix(_.get(site, 'siteMetadata.logo_dark', null))}>
                        <Link to={withPrefix('/')}>
